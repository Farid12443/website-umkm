    ...
    <div class="bg-white rounded-lg shadow p-8">
        ...
        <form method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="kategori" value="<?php echo htmlspecialchars($product['kategori']); ?>" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
            </div>
            ...
            <div class="flex gap-4 pt-4">
                ...
                <a href="dashboard.php" class="flex-1 bg-gray-300 text-gray-700 py-2 rounded-lg font-medium hover:bg-gray-400 transition text-center">Batal</a>
            </div>
        </form>
    </div>
</div>
