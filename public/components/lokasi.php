                 ...
                 <div class="flex-grow">
                     ...
                     <ul class="space-y-3">
                         ...
                         <li
                             ...
                             <div
                                 class="flex-shrink-0 p-3 bg-green-100 rounded-lg text-green-600 group-hover:bg-green-200">
                         ...
                         <li
                             class="flex items-center space-x-3 p-3 rounded-xl hover:bg-gray-50 hover:shadow-md transition-all duration-200 group">
                             <div
                                 class="flex-shrink-0 p-3 bg-blue-100 rounded-lg text-blue-600 group-hover:bg-blue-200">
                         ...
                         <li
                             class="flex items-center space-x-3 p-3 rounded-xl hover:bg-gray-50 hover:shadow-md transition-all duration-200 group">
                             <div
                                 class="flex-shrink-0 p-3 bg-pink-100 rounded-lg text-pink-600 group-hover:bg-pink-200">
                                 <i class="fa-brands fa-instagram text-base"></i>
                             </div>
                             <a
                                 href="https://instagram.com/umkmberas"
                                 target="_blank"
