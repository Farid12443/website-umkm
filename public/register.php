                    ...
                    <div class="no-scrollbar max-w-sm mx-auto w-full bg-white p-6 rounded-2xl md:overflow-y-auto md:max-h-[500px]">
                        ...
                        <form action="register.php" method="POST" class="space-y-4">
                            ...
                            <div>
                                ...
                                <div class="flex items-center border-b-2 border-gray-300 focus-within:border-green-500 relative">
                                    <input type="password" id="confirmPassword" name="confirm_password" class="w-full py-2 outline-none text-sm">
                                        <button type="button" onclick="togglePassword('confirmPassword')" class="absolute right-4 text-gray-400 hover:text-gray-600">
                                            <i class="fa-solid fa-eye"></i>
                                        </button>
